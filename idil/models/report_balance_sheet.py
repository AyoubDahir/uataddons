...
class BalanceSheetWizard(models.TransientModel):
    ...
    def action_print_pdf(self):
        ...
        return self.env.ref('idil.action_report_balance_sheet_pdf').report_action(self, data={
    ...
    def action_print_html(self):
        ...
        return self.env.ref('idil.action_report_balance_sheet_html').report_action(self, data={
            'company_id': self.company_id.id,
            'report_date': self.report_date,
            'bs_data': bs_data
        })
    ...
    def _generate_lines(self):
        ...
        # Net Profit
        add_line('PL', 'Retained Earnings & Current Profit', data['net_profit'], is_total=True)
        
        # Grand Total
        add_line('', 'TOTAL LIABILITIES & EQUITY', data['total_liab_equity'], is_total=True)
